...
def animate(i, ax1, ax2, xs, temps, lights, temp_c, lux):
    ...
    try:
        new_temp = round(valorLM35, 2)
        new_lux = round(valorLM35, 1)
    except:
        pass
...
label_temp = Label(frame, text='Temperature:', font=dfont, bg='white')
label_celsius = Label(frame, textvariable=temp_c, font=dfont, bg='white')
label_unitc = Label(frame, text="C", font=dfont, bg='white')
label_light = Label(frame, text="Light:", font=dfont, bg='white')
label_lux = Label(frame, textvariable=lux, font=dfont, bg='white')
label_unitlux = Label(frame, text="lux", font=dfont, bg='white')
button_temp = Button(    frame, 
                            text="Toggle Temperature", 
                            font=dfont,
                            command=toggle_temp)
button_light = Button(   frame,
                            text="Toggle Light",
                            font=dfont,
                            command=toggle_light)
button_quit = Button(    frame,
                            text="Quit",
                            font=dfont,
...
label_celsius.grid(row=1, column=4, sticky=E)
label_unitc.grid(row=1, column=5, sticky=W)
label_light.grid(row=2, column=4, columnspan=2)
label_lux.grid(row=3, column=4, sticky=E)
label_unitlux.grid(row=3, column=5, sticky=W)
