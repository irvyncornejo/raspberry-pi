...
with open('lenguajes.csv', mode='w',  newline='') as lenguajes:
    ...
    lenguaje_writer.writerow(['C++', 1979, 'Micrlenguaje_writer.writerow(['Lenguaje', 'Año', 'Aplicación'])ocontroladores'])
